...
import random
boysnames = ['Иван','Борис','Александр','Матвей','Игорь','Егор','Филипп']
boyssurenames =['Борисов','Иванов','Петров','Фадеев','Богомолов','Иванчук','Федоров']
girlsnames = ['Екатерина','Мария','Полина','Анастасия','Виктория','Анжелика','Анна']
girlssurenames  = ['Борисова','Иванова','Петрова','Фадеева','Богомолова','Иванчук','Федорова']
